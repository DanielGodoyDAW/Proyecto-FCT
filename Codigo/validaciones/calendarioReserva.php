<!-- Codigo extraido de las reservas, pendiente de modificacion para las citas -->
<?php
if (($_SERVER["REQUEST_METHOD"] == "POST") && isset($_POST["idPaciente"]) && isset($_POST["idTratamiento"])) {
...
?>
    ...
    <div class="contenedorBotonesCalendario">
        <form action="reserva.php#calendarioReservas" method="post">
            <input type="hidden" name="idPaciente" value="<?php echo $_POST["idPaciente"] ?>">
            <input type="hidden" name="idTratamiento" value="<?php echo $_POST["idTratamiento"] ?>">
            <table>
                <tr>
                    <td>
                    ...
                    <td>
                        <button class="botones" type="submit">Seleccionar</button>
                    </td>
                </tr>
            </table>
        </form>
...
//! todo esto cambiarlo con los datos de la bd nueva
