    ...
    if ($result->num_rows > 0) {
        ...
        try {
            ...
            $mail->Body = "
                ...
                <p><a href='http://localhost/Proyecto%20FTC/Proyecto_FCT/Codigo/validaciones/recuperarContra/restablecer_contrasena.php?token=$token'>Restablecer contraseña</a></p>
